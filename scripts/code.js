$(function() {
  ...
  -> Forgot to put () on the update count function. Fixed!
  #################################################*/
    ...
    $newItemForm.on("submit", function(e) {
      ...
      e.preventDefault(); // Prevent form being submitted
          ...
          $list.append("<li class='" + Favorite + "'>" + lowerCase + "</li>"); // Add item to end of the list
  ...
  -BC 
  -> Created a variable "Favorite" which adds all the 
     items into the list as favortite. Feature add Fixed!
  #################################################*/	
  ...
  -BC 
  ##################################################
-Fix for the problem would be to create variables that has the 
-duplicate, listitems and blank value stored into.
-Check for the listitems with the textContent to make sure it
-is lowercase.
-if to check if the duplicate and blank is not true 
-else to to alert the user that it cannot be a blank 
or a duplicate.
